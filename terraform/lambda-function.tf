...
# Note: aws_lambda_permission resource in provider 5.x doesn't support condition blocks.
# The permission will work without conditions, but conditions are enforced at the Function URL level.
